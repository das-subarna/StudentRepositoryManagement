...
$username=$_SESSION['slogin'];
    $sql ="SELECT Password FROM student WHERE RollId=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update student set Password=:newpassword where RollId=:username";
...
$error="Your Current Password does not match the entered";    
}
}
?>
<!DOCTYPE html>
